        ...
        if db.query(ProkerDB).count() == 0:
            sample_prokers = [
                ProkerDB(
                    type="Proker Bersama",
                    owner_name=None,
                    title="Bimbingan Belajar Andongsili Kreatif",
                    description_markdown="Membantu adik-adik tingkat SD dan SMP di Desa Andongsili untuk memahami materi sekolah dengan metode pembelajaran yang interaktif, visual, dan menyenangkan. Dilaksanakan di balai RW.",
                    status="Belum Mulai",
                    image_urls=[]
                ),
                ProkerDB(
                ...
                ProkerDB(
                    type="Proker Individu",
                    owner_name="Tata",
                    title="Pengembangan Website Profil Desa Andongsili",
        ...
        if db.query(LogbookDB).count() == 0:
            sample_logbooks = [
                LogbookDB(
                    ...
                    content_markdown="Kami melakukan kunjungan silaturahmi sekaligus pemaparan rencana program kerja umum kepada Kepala Desa Andongsili beserta jajaran perangkat desa. Pertemuan berjalan sangat lancar dan kami mendapatkan izin penuh untuk pelaksanaan program kerja lapangan.",
                    image_urls=[]
                ),
                LogbookDB(
                    phase="Pra-KKN",
                ...
                LogbookDB(
                    ...
                    content_markdown="Hari pertama pelaksanaan KKN secara resmi dimulai. Kami menghadiri upacara penerimaan mahasiswa KKN UPNVYK di kecamatan Mojotengah, dilanjutkan dengan berbenah posko utama di Desa Andongsili.",
                    image_urls=[]
                )
            ]
        ...
        if db.query(GuestbookDB).count() == 0:
            sample_guestbook = [
                GuestbookDB(
                    name="Pak Budi",
                    role="Warga Desa",
                    message="Selamat datang adik-adik KKN UPN, semoga kerasan di Desa Andongsili dan program kerjanya bisa berjalan lancar membantu kemajuan warga kami.",
